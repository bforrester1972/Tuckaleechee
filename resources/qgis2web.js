...
map.getView().fit([-9342815.849179, 4268439.068385, -9318387.652987, 4283954.692996], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">InstalledMeters (QFieldCloud)</h2>';
        return titleElement;
    })(),
